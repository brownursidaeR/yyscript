...
class AutoLocate(QThread):
    ...
    def run(self):
        ...
        win_width = 1152 if win_name == '阴阳师-网易游戏' else 1344
        win_height = 679 if win_name == '阴阳师-网易游戏' else 758
...
class MatchWin(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.init_win()
        self.filepath = ''
        self.base_dir = r'F:\gitee\gitmanage\new_yysscript\src\screenshot'
    ...
    def slot_btn_start_clicked(self):
        win_name = self.ui.le_win.text()
        self.auto_locate = AutoLocate(self, self.filepath, win_name)
